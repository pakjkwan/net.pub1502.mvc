...
<div id="wrap">
	...
	<div id="container"><!-- Center contents (frame)-->
		<div id="content"><!-- Center contents (Print Commentboard) start-->
			<div id="url-navi">yeSooL Comment</div> 
...
<h1>Print! Comment board</h1>
		...
		</div> <!-- Center contents (Print Comment board)  end-->
	</div><!--  container end -->
